/**
 * Node Connections Dialog Module
 * Handles displaying and managing node connections dialog with path-based filtering
 */
...
export function showNodeConnections(nodeId) {
...
export function highlightAllConnections() {
...
export function focusOnConnectionsNode() {
  if (!currentConnectionsNode) {
    console.warn("No node selected for connections");
    return;
  }
...
export function closeConnectionsDialog() {
  const dialog = document.getElementById("node-connections-dialog");
  if (dialog) {
...
export function calculatePathBasedConnections() {
  if (!currentConnectionsNode) {
    console.warn("No node selected for connections");
    return;
  }
